<template>
    <div class="flex flex-col border -border--ge-gray shadow-[1px_1px_2px_1px_rgba(0,0,0,0.25)] p-[20px] rounded-[10px] w-full md:w-[calc(50%-10px)]" v-for="repo in userRepository.data">
        <div class="flex items-center gap-x-[10px]">
            <font-awesome-icon :icon="['fas', 'book-bookmark']" />
            <p class="-text--ge-light-blue text-[1.2rem] font-MontserratBold text-ellipsis overflow-hidden whitespace-nowrap">{{ repo.name }}</p>
        ...
        <div class="flex items-center mt-auto">
            ...
            <div class="ml-auto flex items-center">
                <div class="mx-2 flex items-center gap-x-[5px]">
                    <font-awesome-icon :icon="['far', 'star']" /><p>0</p>
                </div>
                <div class="mx-2 flex items-center">
                    <font-awesome-icon :icon="['fas', 'code-fork']" /><p>0</p>
                </div>
                <div class="mx-2 flex items-center">
                    <font-awesome-icon :icon="['far', 'eye']" /><p>0</p>
                </div>
            </div>
        </div>
    </div>
